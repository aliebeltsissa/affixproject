...
BLP_scores = {}
for sbj in BLP_data.index:
    history_scoreL1 = BLP_data["AoAL1"][sbj] + BLP_data["AoAgioL1"][sbj] + BLP_data["AnniInstiL1"][sbj] + BLP_data["AnniPaeseL1"][sbj] + BLP_data["AnniFamigliaL1"][sbj] + BLP_data["AnniLavoroL1"][sbj]
    print(history_scoreL1)
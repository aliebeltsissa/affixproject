...
chdir("C:\\Users\\annal\\Documents\\GitHub\\affixproject\\data\\BASLv3\\WITHmorphspelling") # set working directory to responses folder
allfiles = [f for f in listdir() if isfile(f)] # get all file names

all_data = []
column_names = ['rt','response','trial_type','time_elapsed','internal_node_id','subject_id','study_id','session_id','stimulus','question_order','success','word','task','new_stim','input','stimuli','item','correct_response','testing_condition','correct','target','confound','name']
